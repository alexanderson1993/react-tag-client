    ...
    <Layout>
      ...
      <div>
        <div>
          ...
          <p>
            React Tag is a live-action game based off of Assassin. The
            objective: <strong>eliminate your target; stay alive</strong>.
          </p>
          ...
          <p>
            ...
            Possible elimination options include photographing the target,
            gently prodding with a spoon, or planting a device, like an alarm or
            rubber snake, which eliminates players when found or activated.
          </p>
        </div>
        <div>
          <h2>Instructions</h2>
